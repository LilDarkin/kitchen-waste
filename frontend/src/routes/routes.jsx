...
const LandingPage = Loadable(
  lazy(() => import("app/pages/login/LandingPage.jsx"))
);
...
const TermsOfUse = Loadable(
  lazy(() => import("app/pages/login/TermsOfUse.jsx"))
);
const ResetPassword = Loadable(
  lazy(() => import("app/pages/login/ResetPassword.jsx"))
);
const Splash = Loadable(lazy(() => import("app/pages/splashing/Splash.jsx")));
const Analysis = Loadable(
  lazy(() => import("app/pages/analysis/Analysis.jsx"))
);
const Welcome = Loadable(lazy(() => import("app/pages/dashboard/Welcome.jsx")));
const Dashboard = Loadable(
  lazy(() => import("app/pages/dashboard/Dashboard.jsx"))
);
...
const UserManual = Loadable(
  lazy(() => import("app/pages/dashboard/UserManual.jsx"))
);
