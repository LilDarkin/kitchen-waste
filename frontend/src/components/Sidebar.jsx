...
const Sidebar = ({ isOpen }) => {
    ...
    const isDashboardActive = currentPath.includes('/dashboard') || currentPath.includes('/welcome');
    ...
    return (
        <div className={`
            ...
            md:rounded-md
        `}>
            <div className="flex flex-row md:flex-col md:gap-6 md:mt-4 w-full items-center justify-around md:justify-start">
                <button 
