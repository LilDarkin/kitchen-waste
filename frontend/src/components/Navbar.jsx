...
import { WiDayCloudy, WiDaySunny, WiThunderstorm, WiCloudy, WiRain } from 'react-icons/wi';
    ...
    return (
        <header className="flex flex-wrap items-center bg-[#E9DFB4] justify-between p-4 shadow-md">
            ...
            <div className="flex items-center gap-4 text-gray-700">
                ...
                <span className="text-sm border-r border-gray-300 pr-4">
                    English
                </span>
                <button
                    className="px-3 py-1.5 text-sm rounded-md bg-green-700 text-white hover:bg-green-800 transition-colors"
                >
                    USER MANUAL
                </button>
            </div>
