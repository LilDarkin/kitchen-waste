...
const NoModal = ({ isOpen, onClose, title, children }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black/30 backdrop-blur-sm">
      {/* Outer Bigger Border */}
      <div className="border border-gray-600 rounded-xl p-8 w-[460px] bg-[#44562F] flex justify-center items-center shadow-lg relative">
        {/* Inner Modal */}
        <div className="border border-gray-500 rounded-lg p-6 w-[400px] text-center bg-[#83934D] shadow-md relative">
