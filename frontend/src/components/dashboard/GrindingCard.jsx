const GrindingCard = ({className}) => {
    ...
    return (
        <div id="dashboard-card2" className={`${className} flex items-center justify-between rounded-3xl bg-pink-200 h-24 px-6`}>
            <p className="">Grinding</p>
            ...
            <div className="relative w-16 h-16">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center text-gray-700">
                   <img src="/icons/grinding.svg" alt="drying" />
                </div>
            </div>
        </div>
    )
